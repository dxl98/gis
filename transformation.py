...
class OtherstoDD1:
    ...
    def ddm2_to_dd1(self):
        ...
        if lat_dir == 'S':
            ...
            lat_minute = -lat_minute
        new_lat = lat_degree + lat_minute  # 对于南纬坐标，确保整体为负
...
def ups_to_dd1(ups_coords):
    """
    Convert UPS coordinates to Latitude and Longitude.

    Parameters:
    - E, N: UPS coordinates in meters.
...
#
# print(f"{value}{unit} 转换为 cm: {converted_cm}cm")
# print(f"{value}{unit} 转换为 dm: {converted_dm}dm")
# print(f"{value}{unit} 转换为 ft: {converted_ft}ft")
# print(f"{value}{unit} 转换为 in: {converted_in}in")
# print(f"{value}{unit} 转换为 km: {converted_km}km")
# print(f"{value}{unit} 转换为 mi: {converted_mi}mi")
# print(f"{value}{unit} 转换为 mm: {converted_mm}mm")
# print(f"{value}{unit} 转换为 nmi: {converted_nmi}nmi")
# print(f"{value}{unit} 转换为 pt: {converted_pt}pt")
# print(f"{value}{unit} 转换为 usft: {converted_usft}usft")
# print(f"{value}{unit} 转换为 yd: {converted_yd}yd")
